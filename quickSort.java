...
public class quickSort {
    public static void main(String[] args) {
        ...
        //populate list with max value of 1000
        ...
        //declare pivot value for quick sort
        int pivot_value = random.nextInt(1000);

        //break list into two depending on the pivot value
        for (int i = 0; i < size; i++) {
            if (pivot_value > ori_list.get(i)) {
